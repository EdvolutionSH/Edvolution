...
class ResellerModule(models.Model):
    ...
    def sync_contacts(self):
        ...
        try:
            ...
            _logger.error("Se produjo un error inesperado al sincronizar contactos: %s", personal_data)
            _logger.error("Se produjo un error inesperado al sincronizar contactos: %s", company_data)
